package com.di.jdbc.mapper.connection;
...
public class ConnectionPool {
	...
	public ConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPassword, int initialConnections,
			int maxConnections) {
		super();
		this.jdbcDriver = jdbcDriver;
		this.dbUrl = dbUrl;
	...
	public synchronized void createPool() throws Exception {
		...
		System.out.println("The database connection was created");
	}
